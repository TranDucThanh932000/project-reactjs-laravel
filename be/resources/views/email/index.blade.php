    ...
    <div class='container'>
        <div class='container__content'>
            ...
            <div class='container__title' style="margin-left: 20px;">
                <p class='container__mainTitle'>BÚ ĐẪM</p>
                <p class='container__subTitle'>{{ $date }}</p>
                <p class='container__mainTitle'><span style="font-size: 25px;">Số may mắn hôm nay là:</span></p>
                <p class='container__mainTitle'><span style="color:red">{{ $luckyNumber }}</span></p>
            </div>
        </div>
    </div>
</body>
